...
'''label_colours = [(0,0,0)
                # 0=Background
                ,(0.5,0,0),(0.9961,0,0),(0,0.3320,0),(0.6641,0,0.1192),(0.9961,0.3320,0)
                # 1=Hat,  2=Hair,    3=Glove, 4=Sunglasses, 5=UpperClothes
                ,(0,0,0.3320),(0,0.4648,0.8633),(0.3320,0.3320,0),(0,0.3320,0.3320),(0.3320,0.1992,0)
                # 6=Dress, 7=Coat, 8=Socks, 9=Pants, 10=Jumpsuits
                ,(0.2031,0.3359,0.5),(0,0.5,0),(0,0,0.9961),(0.1992,0.6641,0.8633),(0,0.9961,0.9961)
                # 11=Scarf, 12=Skirt, 13=Face, 14=LeftArm, 15=RightArm
                ,(0.3320,0.9961,0.6641),(0.6641,0.9961,0.3320),(0.9961,0.9961,0),(0.9961,0.6641,0)]
                # 16=LeftLeg, 17=RightLeg, 18=LeftShoe, 19=RightShoe'''
# image mean
